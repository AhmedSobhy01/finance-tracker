...
<script>
export default {
    props: ["addBorrowingUrl", "isMorePages", "people", "addToTable"],
                    ...
                    if (this.addToTable) {
                        ...
                        let newData = `
                            ...
                            data.person.name
                                ...
                                <td>
                                    <div class="d-flex justify-content-center align-items-center">
                                        ${
                                            data.paid_at === null
                                                ? '<button class="paid-borrowing-btn btn py-0 text-success" onclick="changeState(event, ' +
                                                  data.id +
                                                  ')" title="' +
                                                  this.trans(
                                                      "main.borrowing_paid"
                                                ...
                                                : '<button class="paid-borrowing-btn btn py-0 text-danger" onclick="changeState(event, ' +
                                                  data.id +
                                                  ')" title="' +
                                                  this.trans(
                                                      "main.borrowing_unpaid"
                                                  ) +
                            ...
                            "main.view_process"
                                        ...
                                        <button class="delete-borrowing-btn btn py-0 text-danger" onclick="deleteborrowing(event, ${
                                            data.id
                                        })" title="${this.trans(
                            "main.delete_borrowing"
